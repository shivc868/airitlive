...
const ContactUs = () => {
  return (
    <section className="bg-lavender py-9 xl:py-12 px-4">
      <div className="flex justify-between md:flex-row flex-col gap-6 items-center max-w-[1033px] mx-auto">
        <div className="lg:max-w-[558px] space-y-5 md:space-y-10 lg:space-y-14 w-full">
          <h3 className="text-lg sm:text-xl md:text-3xl lg:text-[40px] xl:text-[48px] font-semibold font-lato lg:leading-[119%]">
