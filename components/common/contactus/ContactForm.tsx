  ...
  return (
    <div className="bg-lavenderIndigo p-5 lg:p-12 lg:max-w-[477px] w-full rounded-[19px] lg:rounded-[29.525px] backdrop-blur-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className=" rounded-[92.265px] mt-14 bg-purple text-white text-base  font-semibold font-inter px-5 py-2 w-fit transition duration-300 hover:bg-thunder hover:text-white"
        >
          Submit
        </button>
      </form>
