  ...
  return (
    <>
      ...
      >
        <section
          ref={section1Ref}
          className={`${styles.container} flex flex-col lg:flex-row items-center justify-between sm:py-16 px-4 transition-opacity duration-1000 ${
      ...
      <section
        ref={section2Ref}
        className={`${styles.container} flex flex-col-reverse lg:flex-row-reverse items-center justify-between py-16 px-4 transition-opacity duration-1000 ${
