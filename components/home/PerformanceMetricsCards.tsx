...
const PerformanceMetricsCards: React.FC<PerformanceMetricsCardsProps> = ({
  ...
  return (
    <div className="max-w-[292px] mb-8 sm:mb-0 justify-center items-center lg:justify-start lg:items-start flex flex-col gap-3 w-full">
      <h2 className="text-3xl md:text-5xl lg:text-[60px] font-semibold gradient-hero-main-text">
        {percentage}
      </h2>
