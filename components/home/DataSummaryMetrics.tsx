        ...
        return (
          <div
            ...
            className={`flex px-4 py-4  flex-col ${
              isLast ? "" : "border-[#EED3FF] border-r-[3px]"
            }`}
          >
            <h2 className="text-[40px] text-center text-honey font-inter leading-[120%]">
              {data.value}
            </h2>

            <p className="text-lg font-medium text-center text-honey font-inter leading-[1.2]">
              {data.title}
            </p>
          </div>
        );
